...
This chart is tested with the latest 7.5.0-SNAPSHOT version.
...
* Install it:
  - with Helm 3: `helm install kibana ./helm-charts/kibana --set imageTag=7.5.0-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name kibana ./helm-charts/kibana --set imageTag=7.5.0-SNAPSHOT`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `7.5.0-SNAPSHOT`                  |
